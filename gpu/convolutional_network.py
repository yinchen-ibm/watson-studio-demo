...
try:
    ...
    conv_filter_size2 = json_obj["conv_filter_size2"]
    fc = json_obj["fc"]
except:
    pass
...
def main(argv):
    ...
    global train_images_file, train_labels_file, test_images_file, test_labels_file, training_iters
...
def conv_net(x, weights, biases, dropout):
    ...
    conv1 = maxpool2d(conv1, k=pool_filter_size)

    # Convolution Layer
    conv2 = conv2d(conv1, weights['wc2'], biases['bc2'])
    # Max Pooling (down-sampling)
    conv2 = maxpool2d(conv2, k=pool_filter_size)
...
biases = {
    ...
    'bd1': tf.Variable(tf.random_normal([fc])),
